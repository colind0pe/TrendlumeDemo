...
from trendlume.utils.os_util import list_resource_files, get_root_path, get_data_path
from trendlume.utils.template_util import get_all_templates_with_info

router = APIRouter(prefix="/resources", tags=["Resources"])


@router.get("/workflows/tts", response_model=WorkflowListResponse)
async def list_tts_workflows(trendlume: TrendlumeDep):
    """
    ...
    try:
        ...
        all_workflows = trendlume.tts.list_workflows()
...
async def list_media_workflows(trendlume: TrendlumeDep):
    """
    ...
    try:
        ...
        all_workflows = trendlume.media.list_workflows()
...
async def list_image_workflows(trendlume: TrendlumeDep):
    """
