...
class TrendlumeCore:
    ...
    Usage:
        ...
        media = await trendlume.media(prompt="a cat")
        
        # Check active capabilities
        print(f"Using LLM: {trendlume.llm.active}")
        print(f"Available TTS: {trendlume.tts.available}")
    
    Architecture:
        TrendlumeCore (this class)
    ...
    async def initialize(self):
        ...
        if self._initialized:
            logger.warning("Trendlume already initialized")
            return
        
        logger.info("🚀 Initializing Trendlume...")
    ...
    def __repr__(self) -> str:
        ...
        return f"<TrendlumeCore project={self.project_name!r} status={status} {pipelines}>"
