...
Provides utilities for managing paths and files in Trendlume.
"""
...
def get_trendlume_root_path() -> str:
    """
    Get Trendlume root path
    
    Uses TRENDLUME_ROOT (or legacy TRENDLUME_ROOT) environment variable to determine project root.
    ...
    env_root = os.environ.get("TRENDLUME_ROOT") or os.environ.get("TRENDLUME_ROOT")
...
get_trendlume_root_path = get_trendlume_root_path  # Alias for backward compatibility


def ensure_trendlume_root_path() -> str:
    """
    Ensure Trendlume root path exists and return the path
    
    Returns:
        Root path as string
    """
    root_path = get_trendlume_root_path()
...
ensure_trendlume_root_path = ensure_trendlume_root_path  # Alias for backward compatibility


def get_root_path(*paths: str) -> str:
    """
    Get path relative to Trendlume root path
    ...
    """
    root_path = ensure_trendlume_root_path()
    if paths:
...
def get_temp_path(*paths: str) -> str:
    """
    Get path relative to Trendlume temp folder
...
def get_data_path(*paths: str) -> str:
    """
    Get path relative to Trendlume data folder
...
def get_output_path(*paths: str) -> str:
    """
    Get path relative to Trendlume output folder
