...
from .schema import TrendlumeVideoConfig
...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        self.config: TrendlumeVideoConfig = self._load()
        self._initialized = True
    
    def _load(self) -> TrendlumeVideoConfig:
        """Load configuration from file"""
        data = load_config_dict(str(self.config_path))
        config = TrendlumeVideoConfig(**data)
    ...
    def update(self, updates: dict):
        ...
        self.config = TrendlumeVideoConfig(**merged)
    ...
    def set_llm_config(self, api_key: str, base_url: str, model: str):
        ...
        from trendlume.utils.llm_util import normalize_openai_base_url
