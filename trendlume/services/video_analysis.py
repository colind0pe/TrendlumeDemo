...
class VideoAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await trendlume.video_analysis("path/to/video.mp4")
        
        # Use local ComfyUI (future)
        description = await trendlume.video_analysis(
            "path/to/video.mp4",
            source="selfhost"
        )
        
        # List available workflows
        workflows = trendlume.video_analysis.list_workflows()
    """
    ...
    def __init__(self, config: dict, core=None):
        ...
        Args:
            ...
            core: TrendlumeCore instance (for accessing shared ComfyKit)
        """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await trendlume.video_analysis("temp/01_segment.mp4")
        ...
        """
        from trendlume.utils.workflow_util import resolve_workflow_path
