...
from trendlume.utils.tts_util import edge_tts
from trendlume.tts_voices import speed_to_rate
...
class TTSService(ComfyBaseService):
    ...
    Usage:
        ...
        audio_path = await trendlume.tts(text="Hello, world!")
        
        # Use specific workflow
        audio_path = await trendlume.tts(
            text="你好，世界！",
            workflow="tts_edge.json"
        )
        
        # List available workflows
        workflows = trendlume.tts.list_workflows()
    """
