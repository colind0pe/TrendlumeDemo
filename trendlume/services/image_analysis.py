...
class ImageAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await trendlume.image_analysis("path/to/image.jpg")
        
        # Use local ComfyUI
        description = await trendlume.image_analysis(
            "path/to/image.jpg",
            source="selfhost"
        )
        
        # List available workflows
        workflows = trendlume.image_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await trendlume.image_analysis("temp/06.JPG")
