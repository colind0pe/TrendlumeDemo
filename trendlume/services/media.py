...
class MediaService(ComfyBaseService):
    ...
    Usage:
        ...
        media = await trendlume.media(
            prompt="a cat",
            workflow="image_flux.json"
        )
        
        # List available workflows
        workflows = trendlume.media.list_workflows()
    """
    ...
    def _scan_workflows(self):
        ...
        """
        from trendlume.utils.os_util import list_resource_dirs, list_resource_files, get_resource_path
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            media = await trendlume.media(prompt="a beautiful cat")
            if media.is_image:
