...
from trendlume.utils.os_util import get_output_path


class APIProviderMediaService:
    """Adapter from Trendlume media calls to direct provider API clients."""
    ...
    VIDEO_MODEL_CAPABILITIES: dict[tuple[str, str], dict[str, Any]] = {
        ...
        ("dashscope", "wan2.7-i2v"): {
            ...
            "contract_issues": [
                "Trendlume UI exposes first-frame image-to-video; asset-based workflow can optionally pass narration audio as driving_audio.",
    ...
    async def _generate_image(
        ...
        **params,
        ...
        from trendlume.services.api_services.image_client import ImageClient
        ...
        session_id = params.get("session_id") or "trendlume"
    ...
    async def _generate_video(
        ...
        **params,
        ...
        from trendlume.services.api_services.video_client import VideoClient
...
""".strip()
    ...
    def _video_options(
        ...
        """Map Trendlume's generic video params to provider client options."""
