...
from trendlume.pipelines.base import BasePipeline
...
class CustomPipeline(BasePipeline):
    ...
    Example usage:
        ...
        trendlume.pipelines["my_custom"] = CustomPipeline(trendlume)
    ...
    async def __call__(
        ...
        from trendlume.utils.template_util import resolve_template_path, get_template_type
        ...
        from trendlume.utils.content_generators import generate_title
        ...
        # from trendlume.utils.content_generators import generate_narrations_from_topic
        ...
        if template_requires_image:
            ...
            from trendlume.utils.content_generators import generate_image_prompts
...
# Use immediately
trendlume.pipelines["quick"] = QuickPipeline(trendlume)
result = await trendlume.generate_video(text=content, pipeline="quick")
"""
