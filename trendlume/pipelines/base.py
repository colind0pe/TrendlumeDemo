...
from trendlume.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, trendlume_core):
        """
        Initialize pipeline with core services
        
        Args:
            trendlume_core: TrendlumeCore instance (provides access to all services)
        """
        self.core = trendlume_core
        
        # Quick access to services (convenience)
        self.llm = trendlume_core.llm
        self.tts = trendlume_core.tts
        self.media = trendlume_core.media
        self.video = trendlume_core.video
        
        # Backward compatibility alias
        self.image = trendlume_core.media
